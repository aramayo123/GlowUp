        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{ route('servicios.store') }}" method="post">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-1">
                    <div>
                        <label for="nombre_servicio" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre del servicio</label>
                        <input type="text" name="nombre_servicio" id="nombre_servicio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nombre de un servicio" required="">
                        @error('nombre_servicio')
                        <p class="pt-4 text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
