                        ...
                        @forelse ($promociones as $promocion)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex flex-col md:flex-row">
                                    ...
                                    <button onclick="MostrarDelete({{ $promocion }})" type="button" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
 ...
 <div id="deleteModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <p class="mb-4 text-gray-500 dark:text-gray-300">¿Estás seguro de que quieres eliminar esta promo?</p>
            ...
            <form action="{{ route('promociones.store') }}" method="post">
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <div>
                        ...
                        <input type="text" name="nombre_promocion" id="nombre_promocion"  value="{{ old('nombre_promocion') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nombre de una promocion" required="">
                    ...
                    <div>
                        ...
                        <input type="number" name="precio_promocion" id="precio_promocion" value="{{ old('precio_promocion') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$2999" required="">
                            ...
                            @foreach($servicios as $servicio)    
                                <li class="w-full dark:bg-gray-700 dark:border-gray-600 border-b rounded border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="selected_{{ $cont }}" type="checkbox" value="{{ $servicio->id }}" name="servicios[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="selected_{{ $cont }}" class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $servicio->nombre_servicio }}</label>
                                    </div>
                                </li>
                                @php
                                    $cont++;
